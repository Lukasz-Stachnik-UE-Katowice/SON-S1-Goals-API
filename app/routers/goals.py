...
async def post_goal(goal_obj: Goal): #Here we need to add goal model that is going to be created https://fastapi.tiangolo.com/tutorial/body/
...
async def archive_goal(goal_id: int):
    for goal in goals:
        if goal.id == goal_id:
            if goal.archived:
